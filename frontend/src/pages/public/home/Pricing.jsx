      ...
      <div className="grid gap-8 md:grid-cols-3">
        {tiers.map((tier, index) => {
          ...
          return (
            <div
              key={index}
              className={`p-8 rounded-2xl shadow-md transition transform hover:scale-105 ${tier.highlight
            ...
            >
              ...
              <ul className="space-y-3 mb-6">
                {tier.benefits.map((benefit, i) => (
                  ...
                  >
                    <Check
                      className={`w-5 h-5 ${tier.highlight ? "text-white" : "text-green-500"
                        }`}
                    />
                    {benefit}
                  </li>
              ...
              {/* CTA Button */}
              <button
                className={`w-full px-6 py-3 rounded-xl font-semibold transition ${tier.highlight
